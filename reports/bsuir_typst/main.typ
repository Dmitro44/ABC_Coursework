...
#stp.appendix(type:[обязательное],
              title:[Функциональная схема алгоритма, \ реализующего программное средство],
              title-outline:[Функциональная схема алгоритма, реализующего программное средство], [


])

#stp.appendix(type:[обязательное],
              title:[Блок схема алгоритма, \ реализующего программное средство],
              title-outline:[Блок схема алгоритма, реализующего программное средство], [


])

#stp.appendix(type:[обязательное],
              title:[Графики сравнения \ производительности процессоров],
              title-outline:[Графики сравнения производительности процессоров], [


])

#stp.appendix(type:[обязательное],
              title:[Графическое представления нагрузки \ на ядра процессоров],
              title-outline:[Графическое представления нагрузки \ на ядра процессоров], [ // тут так и должен быть / 
