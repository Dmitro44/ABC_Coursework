...
#stp.appendix(type:[обязательное],
              title:[Графическое представление нагрузки \ на ядра процессоров],
              title-outline:[Графическое представление нагрузки \ на ядра процессоров], [ // тут так и должен быть / 
