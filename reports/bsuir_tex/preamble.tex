...
\setlength{\footnotemargin}{1.5cm}

% Зачем: Установка стандартного размера шрифта для сноски
...
\cftsetindents{section}{0.5em}{0.7em}
\cftsetindents{subsection}{1.2em}{1.5em}
...
% 16 размер шрифта для заголовка первого уровня и заголовка по центру (например, Введение)
\titleformat{\section}
...
% Зачем: добавление возможности создания нумерованного списка без точки после цифры
\newenvironment{enumerate_num_without_dot}
  {\begin{enumerate}[label=\arabic*~, labelsep=0pt, ref=\arabic*, align=left,
    labelindent=\fivecharsapprox,
    leftmargin=*, itemindent=*]}
  {\end{enumerate}}
...
\bibliographystyle{\rootPathPrefix /workdir/belarus-specific-utf8gost780u}
