...
public:
    ...
    void run_single_threaded_benchmark(const string& output_file_path);
    void run_multithreaded_benchmark(const string& output_file_path, unsigned int num_threads);
